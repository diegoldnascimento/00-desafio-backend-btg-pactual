...
DOCKER_MONGODB=docker exec -it 00-desafio-backend-btg-pactual-mongodb mongosh -u $(ADMIN_USER) -p $(ADMIN_PASSWORD) --authenticationDatabase admin
DOCKER_MONGODB_WITH_CUSTOM_CREDS=docker exec -it 00-desafio-backend-btg-pactual-mongodb mongosh -u $(DB_USER) -p $(DB_PASS) --authenticationDatabase $(DB_NAME)
